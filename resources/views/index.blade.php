...
<!--[if IE 8]> <html lang="en" class="ie8 no-js" data-ng-app="SimbaApp"> <![endif]-->
<!--[if IE 9]> <html lang="en" class="ie9 no-js" data-ng-app="SimbaApp"> <![endif]-->
<!--[if !IE]><!-->
<html lang="en" data-ng-app="SimbaApp">
<!--<![endif]-->
<!-- BEGIN HEAD -->
<head>
...
<div class="container">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div data-ng-include="'tpl/theme-panel.html'" data-ng-controller="ThemePanelController" class="theme-panel hidden-xs hidden-sm" ng-show="false">
    ...
    <form id="_logout" action="api/auth/logout" method="post">
        <input   type="hidden" value="{{$accessToken}}" id="_accessToken" name="accessToken" />
    </form>
    <!-- END FOOTER -->
</div>
<!-- END CONTAINER -->
